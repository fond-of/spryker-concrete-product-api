...
{
    /**
     * @var \FondOfSpryker\Zed\ConcreteProductApi\Dependency\Facade\ConcreteProductApiToProductFacadeBridge
     */
    ...
    {
        $this->productFacadeInterfaceMock->expects($this->atLeastOnce())
        ...
        $this->assertInstanceOf(
            ...
            $this->concreteProductApiToProductFacadeBridge->findProductConcreteById(
                $this->idProduct
            )
        );
    }
